...
function carregarFilmes() {
    ...
    for (var i = 0; i < filmes.length; i++) {
        ...
        html += '<img src="' + filme.imagem + '" alt="' + filme.titulo + '" class="card-imagem" onerror="this.style.opacity=\'0\'">';
        ...
        html += '<span class="card-genero">' + filme.categoria + '</span>';
...
function carregarDetalhes() {
    ...
    html += '<img src="' + filme.imagem + '" alt="' + filme.titulo + '" class="detalhe-imagem" onerror="this.style.opacity=\'0\'">';
    ...
    html += '<p class="detalhe-sinopse">' + filme.conteudo + '</p>';

    html += '<ul class="detalhe-lista">';
    html += '<li><span class="detalhe-label">Categoria</span><span>' + filme.categoria + '</span></li>';
...
function criarSlider() {
    filmesDestaque = [];
    for (var i = 0; i < filmes.length; i++) {
        if (filmes[i].destaque === true) {
            filmesDestaque.push(filmes[i]);
        }
    }
    ...
    for (var i = 0; i < filmesDestaque.length; i++) {
        ...
        html += '<img src="' + filme.imagem + '" alt="' + filme.titulo + '" class="slide-imagem" onerror="this.style.opacity=\'0\'">';
        html += '</div>';
